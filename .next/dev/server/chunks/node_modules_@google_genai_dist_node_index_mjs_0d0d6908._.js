module.exports = [
"[project]/node_modules/@google/genai/dist/node/index.mjs [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class NodeAuth {
    constructor(opts){
        ...
        this.googleAuth = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$google$2d$auth$2d$library$2f$build$2f$src$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["GoogleAuth"](vertexAuthOptions);
    }
    ...
    async download(params, apiClient) {
        if (params.downloadPath) {
            ...
            if (response instanceof HttpResponse) {
                const writer = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["createWriteStream"])(params.downloadPath);
                const body = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$stream__$5b$external$5d$__$28$node$3a$stream$2c$__cjs$29$__["Readable"].fromWeb(response.responseInternal.body);
                body.pipe(writer);
                await (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$stream$2f$promises__$5b$external$5d$__$28$node$3a$stream$2f$promises$2c$__cjs$29$__["finished"])(writer);
            } else {
                try {
                    await (0, __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["writeFile"])(params.downloadPath, response, {
                        encoding: 'base64'
                    });
                } catch (error) {
...
class NodeWebSocket {
    ...
    connect() {
        this.ws = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ws$2f$lib$2f$websocket$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__default__as__WebSocket$3e$__["WebSocket"](this.url, {
 ...
 */ class NodeUploader {
    async stat(file) {
        ...
        if (typeof file === 'string') {
            const originalStat = await __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["stat"](file);
    ...
    async uploadFileFromPathInternal(file, uploadUrl, apiClient) {
        ...
        let uploadCommand = 'upload';
        let fileHandle;
        const fileName = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["basename"](file);
        try {
            fileHandle = await __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["open"](file, 'r');
            if (!fileHandle) {
...
//# sourceMappingURL=node_modules_%40google_genai_dist_node_index_mjs_0d0d6908._.js.map